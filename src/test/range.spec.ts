...
import { clamp, within, normalize, random, wrap } from "../lib/range.ts"
...
describe("`inside()`", () => {
  test("00", () => expect(within(0, 0, -10)).toBe(null))
  test("01", () => expect(within(0, 0, -1)).toBe(null))
  test("02", () => expect(within(0, 0, 0)).toBe(0))
  test("03", () => expect(within(0, 0, 1)).toBe(null))
  test("04", () => expect(within(0, 0, 10)).toBe(null))

  test("05", () => expect(within(1, 1, -10)).toBe(null))
  test("06", () => expect(within(1, 1, -1)).toBe(null))
  test("07", () => expect(within(1, 1, 0)).toBe(null))
  test("08", () => expect(within(1, 1, 1)).toBe(1))
  test("09", () => expect(within(1, 1, 10)).toBe(null))

  test("10", () => expect(within(-1, -1, -10)).toBe(null))
  test("11", () => expect(within(-1, -1, -1)).toBe(-1))
  test("12", () => expect(within(-1, -1, 0)).toBe(null))
  test("13", () => expect(within(-1, -1, 1)).toBe(null))
  test("14", () => expect(within(-1, -1, 10)).toBe(null))

  test("15", () => expect(within(2, 6, -100)).toBe(null))
  test("16", () => expect(within(2, 6, -4)).toBe(null))
  test("17", () => expect(within(2, 6, -3)).toBe(null))
  test("18", () => expect(within(2, 6, -2)).toBe(null))
  test("16", () => expect(within(2, 6, -1)).toBe(null))
  test("17", () => expect(within(2, 6, 0)).toBe(null))
  test("18", () => expect(within(2, 6, 1)).toBe(null))
  test("19", () => expect(within(2, 6, 2)).toBe(2))
  test("20", () => expect(within(2, 6, 3)).toBe(3))
  test("21", () => expect(within(2, 6, 4)).toBe(4))
  test("22", () => expect(within(2, 6, 5)).toBe(5))
  test("23", () => expect(within(2, 6, 6)).toBe(6))
  test("24", () => expect(within(2, 6, 7)).toBe(null))
  test("25", () => expect(within(2, 6, 8)).toBe(null))
  test("26", () => expect(within(2, 6, 9)).toBe(null))
  test("27", () => expect(within(2, 6, 100)).toBe(null))

  test("28", () => expect(within(-4, 3, -100)).toBe(null))
  test("29", () => expect(within(-4, 3, -5)).toBe(null))
  test("30", () => expect(within(-4, 3, -4)).toBe(-4))
  test("31", () => expect(within(-4, 3, -3)).toBe(-3))
  test("32", () => expect(within(-4, 3, -2)).toBe(-2))
  test("33", () => expect(within(-4, 3, -1)).toBe(-1))
  test("34", () => expect(within(-4, 3, 0)).toBe(0))
  test("35", () => expect(within(-4, 3, 1)).toBe(1))
  test("36", () => expect(within(-4, 3, 2)).toBe(2))
  test("37", () => expect(within(-4, 3, 3)).toBe(3))
  test("38", () => expect(within(-4, 3, 4)).toBe(null))
  test("39", () => expect(within(-4, 3, 5)).toBe(null))
  test("40", () => expect(within(-4, 3, 6)).toBe(null))
  test("41", () => expect(within(-4, 3, 100)).toBe(null))

  test("42", () => expect(within(-4, -1, -100)).toBe(null))
  test("43", () => expect(within(-4, -1, -5)).toBe(null))
  test("44", () => expect(within(-4, -1, -4)).toBe(-4))
  test("45", () => expect(within(-4, -1, -3)).toBe(-3))
  test("46", () => expect(within(-4, -1, -2)).toBe(-2))
  test("47", () => expect(within(-4, -1, -1)).toBe(-1))
  test("48", () => expect(within(-4, -1, 0)).toBe(null))
  test("49", () => expect(within(-4, -1, 1)).toBe(null))
  test("50", () => expect(within(-4, -1, 2)).toBe(null))
  test("51", () => expect(within(-4, -1, 3)).toBe(null))
  test("52", () => expect(within(-4, -1, 4)).toBe(null))
  test("53", () => expect(within(-4, -1, 5)).toBe(null))
  test("54", () => expect(within(-4, -1, 100)).toBe(null))
})
